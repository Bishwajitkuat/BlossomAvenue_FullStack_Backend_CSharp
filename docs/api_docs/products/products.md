...
```
GET base_url/api/v1/products?page=page_number&search_by=search_word&order_by_price=order
```
...
HTTP status 200 with
{
  ...
  "page": 1, // int
  "search_by": "rose", // null or string
  "order_by_price" : "asc", // or "desc" or null
 "products": [
  {
...
{
    "message": "Server cannot find the products. Please wait and try again or contact system administrator." // message | string
}
```
...
HTTP status 404 with
{
    "message": "Server cannot find the product. Please wait and try again or contact system administrator." // message | string
}
```
...
{
  "message": "Data is/are missing missing to create new product."  // string
}
```
...
{
  "message": "Only admin users are authorized to create a product." // string
}
```
...
HTTP status 400 with
{
  "message": "Data is/are missing to update the product."  // string
}
```
...
HTTP status 401 with
{
  "message": "Only admin users are authorized to update a product." // string
}
```
...
HTTP status 401 with
{
  "message": "Only admin users are authorized to delete a product." // string
}
```
